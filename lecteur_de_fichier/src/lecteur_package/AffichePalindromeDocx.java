...
public class AffichePalindromeDocx extends AbsAfficheDocx {
	protected String s;

	AffichePalindromeDocx(int val, JFileChooser choix, BufferedReader Lecteur, Fichier file, XWPFDocument doc) {
